...
Status: **DRAFT FOR CHATGPT + OWNER REVIEW — no restructure authorized by this document.**

Branch: `architecture/ai-first-operating-model-review` (from `main` at `f684025`).
