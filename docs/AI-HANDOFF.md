...
NEXT_CHECKPOINT: PR #135 open (https://github.com/shelterpawtners/LostPaws/pull/135), merged current `main` in cleanly, CI running again. Merge under the standing merge authorization once green.
