...
description: Work on the ShelterPawtners and LostPaws product in this repository using its product rules, brand standards, role boundaries, and engineering context. Use for project documentation, features, UI, marketing, data, and shelter workflows.
---

# ShelterPawtners project workflow

Read [AGENTS.md](../../../AGENTS.md) and [README.md](../../../README.md) first to establish scope and current state. This skill routes to canonical documents; it does not grant permission to implement planned capabilities. The foundation approval gate in AGENTS.md remains binding until the user explicitly lifts it.
...
Validate according to AGENTS.md and the task's actual artifacts. Report completed work accurately, including limits and remaining decisions. Never infer authorization to move from the documentation foundation to application implementation.
